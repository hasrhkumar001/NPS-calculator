...
<body>
    ...
    <p>
        ...
        <br><br>
        <strong><a href="http://127.0.0.1:8000/customersatifactionsurvey/{{$token}}" target="_blank" style="border:1px solid blue; background-color:blue;border-radius:5px;padding:5px;color:white;text-decoration:none;">Take Survey</a></strong>
    </p>
